export function createNavigationMenu() {
  const navItems = {
    dropdowns: {
      plugins: {
        type: 'dropdown',
        current: { label: "Plugins", href: "/plugins" },
        items: [
      ...
      themes: {
        type: 'dropdown',
        current: { label: "Themes", href: "/themes" },
        items: [
      ...
      pricing: {
        type: 'dropdown',
        current: { label: "Pricing", href: "/pricing" },
        items: [
      ...
      resources: {
        type: 'dropdown',
        current: { label: "Resources", href: "/resources" },
      },
    },
  };
