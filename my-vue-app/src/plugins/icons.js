...
const LogoIcon = defineComponent({
  ...
  setup(props) {
    return () => h('svg', {
      ...
      h('path', {
        d: 'M33.5926 10.0799L28.0699 6.74124L26.9222 6.04846C26.3443 6.16514 25.7898 6.3839 25.2825 6.69533L16.5405 11.9579C16.9315 11.8087 17.3492 11.7512 17.7639 11.7894C18.1786 11.8276 18.5801 11.9607 18.94 12.1791L19 12.2167L22.5472 14.3535C24.2269 15.3655 26.1323 15.8983 28.0719 15.8983C30.0115 15.8983 31.9169 15.3655 33.5966 14.3535H33.6206C33.9652 14.1282 34.2493 13.8153 34.4462 13.4441C34.6431 13.0729 34.7465 12.6556 34.7465 12.2313C34.7465 11.807 34.6431 11.3897 34.4462 11.0185C34.2493 10.6473 33.9652 10.3344 33.6206 10.1091L33.5926 10.0799Z',
        fill: `url(#paint0_linear_${props._uid})`
      }),
      h('path', {
        d: 'M26.9058 6.06086C26.3344 6.17598 25.7856 6.39042 25.2822 6.69521L0 21.9238V12.6506C0.000428024 12.1294 0.132196 11.6176 0.382082 11.1663C0.631968 10.7151 0.991181 10.3404 1.42367 10.0798L16.0763 1.26984C16.5086 1.0074 16.9999 0.869141 17.5 0.869141C18.0001 0.869141 18.4914 1.0074 18.9237 1.26984L22.1229 3.18541L26.9058 6.06086Z',
        fill: `url(#paint1_linear_${props._uid})`
      }),
      h('path', {
        d: 'M35 18.4059V29.3318C35.0012 29.8513 34.8718 30.3621 34.6248 30.8132C34.3778 31.2642 34.0218 31.6399 33.5923 31.9025L18.9237 40.7334C18.4907 40.9938 17.9997 41.1308 17.5 41.1308C17.0003 41.1308 16.5093 40.9938 16.0763 40.7334L1.42367 31.9025C0.991181 31.642 0.631968 31.2673 0.382082 30.816C0.132196 30.3648 0.000428024 29.8529 0 29.3318L0 18.4059C0.000428024 18.927 0.132196 19.4389 0.382082 19.8902C0.631968 20.3414 0.991181 20.7161 1.42367 20.9767L16.0763 29.8033C16.5086 30.0658 16.9999 30.204 17.5 30.204C18.0001 30.204 18.4914 30.0658 18.9237 29.8033L33.5923 20.9767C34.0218 20.714 34.3778 20.3384 34.6248 19.8873C34.8718 19.4362 35.0012 18.9254 35 18.4059Z',
